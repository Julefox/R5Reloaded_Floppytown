...
array<entity> function CreateMultipleModel( asset model, vector pos, vector ang, int x = 1, int y = 1, int z = 1, array< int > destroyArrayInt = [], float forceWidth = 0, float forceDepth = 0, float forceHeight = 0 )
{
    vector baseAng = < 0, 0, 0 >
    ...
    if ( forceDepth  != 0 ) depth  = forceDepth
    if ( forceHeight != 0 ) height = forceHeight
    ...
    array< entity > returnedProp = []
    entity entitieCreated
