...
void function Map_Generation()
{
    ...
    LilBalcony01( FT_LIL_BALCONY_01_POS, FT_LIL_BALCONY_01_ANG )
    LilBalcony02( FT_LIL_BALCONY_02_POS, FT_LIL_BALCONY_02_ANG )
    LilBalcony03( FT_LIL_BALCONY_03_POS, FT_LIL_BALCONY_03_ANG )
}
